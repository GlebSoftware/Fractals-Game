...
void Overlays::UpdateMenu(float mouse_x, float mouse_y) {
  //Update text boxes
  MakeText("Fuck\nFractals", 60, 20, 72, sf::Color::White, all_text[TITLE]);
  ...
  MakeText("\xA9""2019 Gleb Alikhver 1.1.1\nDesigned as a part of the\n24 Hour Coding Challenge", 16, 652, 32, sf::Color::White, all_text[CREDITS], true);
